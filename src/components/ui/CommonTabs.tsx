...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-evenly  bg-muted p-1 text-muted-foreground rounded-[10px]",
      className
    )}
    {...props}
  />
  ...
  "inline-flex items-center justify-center whitespace-nowrap  px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50  transition-all ease-in-out",
  {
    variants: {
      variant: {
        ...
        bottomBorder:
          "data-[state=active]:border-b-[3px]  data-[state=active]:border-b-customYellow data-[state=active]:transition-left data-[state=active]:duration-400 ",
      },
    },
    defaultVariants: {
      variant: "default",
